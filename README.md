...
```javascript
UINT8_NUM_BYTES = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-uint8-num-bytes@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-uint8-num-bytes@umd/bundle.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/constants-uint8-num-bytes/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/constants-uint8-num-bytes/actions/workflows/test.yml?query=branch:main
